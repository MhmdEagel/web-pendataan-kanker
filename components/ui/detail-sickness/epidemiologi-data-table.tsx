...
export function EpidemiologiDataTable<TData, TValue>({
  columns,
  data,
  ...
  const pucatTotal = useGetTotalByColumnId(table, "pucat");
  const pendarahanTotal = useGetTotalByColumnId(table, "pendarahan");
  const splenomegaliTotal = useGetTotalByColumnId(table, "splenomegali");
  const demamTotal = useGetTotalByColumnId(table, "demam");
  const hepatomegaliTotal = useGetTotalByColumnId(table, "hepatomegali");
  const tumorTotal = useGetTotalByColumnId(table, "tumor");
